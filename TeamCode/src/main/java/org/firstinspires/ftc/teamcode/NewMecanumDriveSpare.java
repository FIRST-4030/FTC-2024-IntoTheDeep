...
@Config
public class NewMecanumDriveSpare {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(NewMecanumDriveSpare.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(NewMecanumDriveSpare.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(NewMecanumDriveSpare.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(NewMecanumDriveSpare.this.rightFront));
    ...
    public NewMecanumDriveSpare(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
        ...
        localizer = new TwoDeadWheelLocalizerSpare(hardwareMap, lazyImu.get(), PARAMS.inPerTick);
